...
import { returnNotNumbers, returnNumbers } from "../src/utils.js";
import { createReport } from "../src/csv_svc.js";
import { getAdvCards } from "../src/crawler.js";
...
test("has title", async ({ page }) => {
  ...
  logger.info({ count: cards.length }, "Parsed cards, generating report");
  createReport(cards);
